	...
	<div class="page-content">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="table_basic.html" class="nav-link active">Listado de empleados</a></li>
								<li class="nav-item"><a href="table_sizing.html" class="nav-link">Agregar empleado</a></li>
								<li class="nav-item"><a href="table_borders.html" class="nav-link">Editar datos del empleado</a></li>
		...
		<!-- Content area -->
			<div class="content">
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">NOMBRE Y APELLIDO</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">HORARIO DE TRABAJO</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">REFERENCIA</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"></span>
				...
				<!-- /touchspin layouts -->
				<td><button type="button" class="btn bg-info" data-toggle="modal" data-target="#modal_theme_info">REGISTRAR <i class="icon-play3 ml-2"></i></button></td>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header bg-info">
								<h6 class="modal-title">REGISTRO</h6>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn bg-info">Guardar</button>
							</div>
						</div>
					</div>
				</div>
