			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EDITAR EMPLEADO</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_borders.php" class="breadcrumb-item">Tables</a>
					...
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
								<i class="icon-pencil7" data-action="Editar"></i>
								<i class="icon-trash" data-action="Eliminar"></i>
								<i class="icon-cog6" data-action="configuracion"></i>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_default">ELIMINAR <i class="icon-play3 ml-2"></i></button> 

									</td>
									<td>1</td>
									<td>Juan</td>
									<td>Nava</td>
									<td>Juannava27@gmail.com</td>
								</tr>
								<td>
								...
								<tr>
									...
									<td>abelgcbetis98@hotmail.com</td>
								</tr>
								<td>
								...
								<tr>
									...
									<td>Karen</td>
									<td>Rivera</td>
									<td>Karenrivera92183@hotmail.com</td>
								</tr>
								<td>
								...
								<tr>
									...
									<td>Janet</td>
									<td>Olvera</td>
									<td>JanetOlvera7627@gmail.com</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<h6 class="font-weight-semibold">Esta infrmación se eliminara. ¿Seguro que desa continuar? </h6>
								</p>
							</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-link" data-dismiss="modal">CERRAR</button>
								<button type="button" class="btn bg-primary"> ELIMINAR</button>
							</div>
						</div>
					</div>
				</div>
