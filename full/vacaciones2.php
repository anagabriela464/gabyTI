				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="vacaciones.php" class="nav-link active">Listado de vacaciones</a></li>
								<li class="nav-item"><a href="vacaciones2.php" class="nav-link">Agregar empleado</a></li>
								<li class="nav-item"><a href="vacaciones3.php" class="nav-link">Editar datos de vacaciones</a></li>
								<!--<li class="nav-item"><a href="table_styling.html" class="nav-link">Table styling</a></li>
								<li class="nav-item"><a href="table_elements.html" class="nav-link">Table elements</a></li>-->
							</ul>
							<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">AÑOS DE SERVICIO</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="">
											<span class="input-group-append">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">DIAS A DISFRUTAR</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"></span>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">FECHA INICIAL</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"></span>
