			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EMPRESA</span> -EMPLEADOS
...
<!-- Main content -->
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Edicion</span></h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_sizing.php" class="breadcrumb-item">Tables</a>
		...
		<!-- Content area -->
			<div class="content">
				...
				<!--	</td>-->
                <td><button type="button" class="btn bg-teal-300" data-toggle="modal" data-target="#modal_theme_bg_custom">Guardar <i class="icon-play3 ml-2"></i></button></td>
					...
					<div class="modal-dialog">
						<div class="modal-content bg-teal-300">
							...
							<div class="modal-body">
								<h6 class="font-weight-semibold">¿Desea hacer algun cambio?</h6>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-link text-white" data-dismiss="modal">Cerrar</button>
								<button type="button" class="btn bg-teal-600">Guardar</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Alta del departamento</h5>
					...
					<div class="card-body">
						<p class="mb-4">Contesta cada uno de los datos que se te piden</p>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">ÁREA DEL DEPARTAMENTO</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<!--<span class="input-group-text">@</span>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">SUPERVISOR</label>
									<div class="col-lg-10">
										<div class="input-group">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">HORARIO DE JORNADA</label>
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="Horario de Trabajo">
											<span class="input-group-append">
												<span class="input-group-text"></span>
												<span class="input-group-text"></span>
											</span>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">REFERENCIA LABORAL</label>
									<div class="col-lg-10">
										<div class="input-group">
											<span class="input-group-prepend">
												<span class="input-group-text"></span>
											</span>
											<input type="text" class="form-control" placeholder="Referencia Laboral">
											<span class="input-group-append">
												<span class="input-group-text"></span>
											</span>
										</div>
