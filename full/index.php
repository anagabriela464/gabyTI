...
<!--						
						...
						<!-- Tables  -->
<!--lass="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Inicio</div> <i class="icon-menu" title="Tables"></i></li>-->
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-8">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<span class="badge bg-success badge-pill">3 activas</span>
									<div class="list-icons ml-3">
				                		<div class="list-icons-item dropdown">
											...
											<div class="dropdown-menu">
												...
												<div class="dropdown-divider"></div>
												<a href="#" class="dropdown-item"><i class="icon-cross3"></i> Limpiar</a>
											</div>
				                		</div>
				                	</div>
			                	</div>
							...
							<div class="card-body d-sm-flex align-items-sm-center justify-content-sm-between flex-sm-wrap">
								<div class="d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">38,289 <span class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+2.54%)</span></h5>
										<span class="badge badge-mark border-success mr-1"></span> <span class="text-muted">agosto 20:30</span>
									</div>
								</div>
								...
								<div>
									<a href="#" class="btn bg-indigo-300"><i class="icon-statistics mr-2"></i> reporte</a>
								</div>
							</div>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										<tr>
											...
											<td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> 5.68%</span></td>
											<td><h6 class="font-weight-semibold mb-0">$73,567</h6></td>
										...
										<tr>
											...
											<td><span class="text-success-600"><i class="icon-stats-growth2 mr-2"></i> 4.5%</span></td>
											<td><h6 class="font-weight-semibold mb-0">$10,467</h6></td>
										...
										<!--class="table-active table-border-double">
						...
						<div class="row">
							<div class="col-lg-4">
								...
								<div class="card bg-teal-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">6,860</h3>
											<span class="badge bg-teal-800 badge-pill align-self-center ml-auto">+70,6%</span>
					                	</div>
					                	
					                	<div>
											Miembros en línea
											<div class="font-size-sm opacity-75">489 aproximadamente</div>
										</div>
									</div>
							...
							<div class="col-lg-4">
								...
								<div class="card bg-pink-400">
									<div class="card-body">
					                	...
					                	<div>
											Perdidas
											<div class="font-size-sm opacity-75">10.6% promedio</div>
										</div>
									</div>
							...
							<div class="col-lg-4">
								...
								<div class="card bg-blue-400">
									<div class="card-body">
										<div class="d-flex">
											<h3 class="font-weight-semibold mb-0">$30,340</h3>
											<div class="list-icons ml-auto">
					                	...
					                	<div>
											...
											<div class="font-size-sm opacity-75">$87,578 promedio</div>
										</div>
									</div>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Bocaditos México tickets</h6>
								<div class="header-elements">
							...
							<div class="card-body d-md-flex align-items-md-center justify-content-md-between flex-md-wrap">
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">16,038 <span class="text-success font-size-sm font-weight-normal"><i class="icon-arrow-up12"></i> (+5.9%)</span></h5>
										<span class="badge badge-mark border-success mr-1"></span> <span class="text-muted">Septiembre, 11:00 am</span>
									</div>
								</div>
								...
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">5,342</h5>
								...
								<div class="d-flex align-items-center mb-3 mb-md-0">
									...
									<div class="ml-3">
										<h5 class="font-weight-semibold mb-0">03:03:20</h5>
							...
							<div class="table-responsive">
								<table class="table text-nowrap">
									...
									<tbody>
										<tr class="table-active table-border-double">
											<td colspan="3">tickets activo</td>
											<td class="text-right">
												<span class="badge bg-blue badge-pill">14</span>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Industries Lopez</a>
											...
											<td>
												<a href="#" class="text-default">
													<div class="font-weight-semibold">Colonia</div>
													<span class="text-muted">Rayon 345</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
													<div class="list-icons-item dropdown">
														<a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown"><i class="icon-menu7"></i></a>
														<div class="dropdown-menu dropdown-menu-right">
															<a href="#" class="dropdown-item"><i class="icon-undo"></i> Deshacer</a>
															<a href="#" class="dropdown-item"><i class="icon-history"></i>Regresar</a>
															<div class="dropdown-divider"></div>
															<a href="#" class="dropdown-item"><i class="icon-checkmark3 text-success"></i> Resolver</a>
															<a href="#" class="dropdown-item"><i class="icon-cross2 text-danger"></i> Cerrar</a>
														</div>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold">beauty</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
											<td>
												<a href="#" class="text-default">
													<div class="font-weight-semibold">calle</div>
													<span class="text-muted">Miguel Hidalgo 345</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Nature</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
											<td>
												<a href="#" class="text-default">
													<div class="font-weight-semibold">Calle</div>
													<span class="text-muted">Azucena 345</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Creations</a>
														<div class="text-muted font-size-sm"><span class="badge badge-mark border-blue mr-1"></span> Active</div>
													</div>
												</div>
											</td>
											<td>
												<a href="#" class="text-default">
													<div class="font-weight-semibold"> Calle</div>
													<span class="text-muted">Azucena 636</span>
												</a>
											</td>
											<td class="text-center">
												<div class="list-icons">
					...
					<div class="col-xl-4">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Finanzas de industries López</h6>
								<div class="header-elements">
									<span class="font-weight-bold text-danger-600 ml-2">$45,358</span>
									<div class="list-icons ml-3">
				                		<div class="list-icons-item dropdown">
				                			<a href="#" class="list-icons-item dropdown-toggle" data-toggle="dropdown"><i class="icon-cog3"></i></a>
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#" class="dropdown-item"><i class="icon-sync"></i> Actualizar</a>
												<a href="#" class="dropdown-item"><i class="icon-list-unordered"></i> Registro</a>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title">Nature</a>
														<div class="text-muted font-size-sm"><i class="icon-checkmark3 font-size-sm mr-1"></i> Nuevo</div>
													</div>
												</div>
											</td>
											<td>
												<span class="text-muted font-size-sm">04:34 pm</span>
											</td>
											<td>
												<h6 class="font-weight-semibold mb-0">$50.90</h6>
											</td>
										</tr>
										...
										<!--<tr>
											<td>
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="#" class="text-default font-weight-semibold letter-icon-title"></a>
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Mis Notificaciones</h6>
								<div class="header-elements">
									<span><i class="icon-history text-warning mr-2"></i> 14 septiembre, 4:30</span>
							...
							<div class="card-body py-0">
								<div class="row text-center">
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">3,845</h5>
											<span class="text-muted font-size-sm">Hace dos semanas</span>
										</div>
									</div>

									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">8,374</h5>
									...
									<div class="col-4">
										<div class="mb-3">
											<h5 class="font-weight-semibold mb-0">1,493</h5>
											<span class="text-muted font-size-sm">Hoy</span>
										</div>
									</div>
								</div>
							</div>
