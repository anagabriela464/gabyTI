				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="media-title font-weight-semibold">Gabriela Lopez</div>
...
<!--						
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="index." class="nav-link active">Default layout</a></li>
								<li class="nav-item"><a href="layout_2/LTR/default/full/index." class="nav-link">Layout 2</a></li>
								<li class="nav-item"><a href="layout_3/LTR/default/full/index." class="nav-link">Layout 3</a></li>
								<li class="nav-item"><a href="layout_4/LTR/default/full/index." class="nav-link">Layout 4</a></li>
								<li class="nav-item"><a href="layout_5/LTR/default/full/index." class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="layout_6/LTR/default/full/index." class="nav-link disabled">Layout 6 <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								...
								<li class="nav-item"><a href="../../../LTR/material/full/index." class="nav-link">Material</a></li>
								<li class="nav-item"><a href="../../../LTR/dark/full/index." class="nav-link disabled">Dark <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
								<li class="nav-item"><a href="../../../LTR/clean/full/index." class="nav-link disabled">Clean <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Starter kit">
								<li class="nav-item"><a href="../seed/layout_nav_horizontal." class="nav-link">Horizontal navigation</a></li>
								<li class="nav-item"><a href="../seed/sidebar_none." class="nav-link">No sidebar</a></li>
								<li class="nav-item"><a href="../seed/sidebar_main." class="nav-link">1 sidebar</a></li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">2 sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="../seed/sidebar_secondary." class="nav-link">Secondary sidebar</a></li>
										<li class="nav-item"><a href="../seed/sidebar_right." class="nav-link">Right sidebar</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">3 sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="../seed/sidebar_right_hidden." class="nav-link">Right sidebar hidden</a></li>
										<li class="nav-item"><a href="../seed/sidebar_right_visible." class="nav-link">Right sidebar visible</a></li>
									</ul>
								</li>
								<li class="nav-item nav-item-submenu">
									<a href="#" class="nav-link">Content sidebars</a>
									<ul class="nav nav-group-sub">
										<li class="nav-item"><a href="../seed/sidebar_content_left." class="nav-link">Left sidebar</a></li>
										<li class="nav-item"><a href="../seed/sidebar_content_right." class="nav-link">Right sidebar</a></li>
									</ul>
								</li>
								<li class="nav-item"><a href="../seed/layout_boxed." class="nav-link">Boxed layout</a></li>
								<li class="nav-item-divider"></li>
								<li class="nav-item"><a href="../seed/navbar_fixed_main." class="nav-link">Fixed main navbar</a></li>
								<li class="nav-item"><a href="../seed/navbar_fixed_secondary." class="nav-link">Fixed secondary navbar</a></li>
								<li class="nav-item"><a href="../seed/navbar_fixed_both." class="nav-link">Both navbars fixed</a></li>
								<li class="nav-item"><a href="../seed/layout_fixed." class="nav-link">Fixed layout</a></li>
							</ul>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item"><a href="../../../RTL/default/full/index." class="nav-link"><i class="icon-width"></i> <span>RTL version</span></a></li>-->
						<!-- /main -->
								...
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item nav-item-submenu">
											...
											<ul class="nav nav-group-sub">
												<li class="nav-item"><a href="#" class="nav-link"><i class="icon-5"></i> Fourth level</a></li>
						...
						<!-- Tables -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Inicio</div> <i class="icon-menu" title="Tables"></i></li>
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-user-tie"></i> <span>EMPLEADOS</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="table_basic.php" class="nav-link active">Listado de empleados</a></li>
								<li class="nav-item"><a href="table_sizing.php" class="nav-link">Agregar empleado</a></li>
								<li class="nav-item"><a href="table_borders.php" class="nav-link">Editar datos del empleado</a></li>
							...
							<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-airplane2"></i> <span>VACACIONES DE EMPLEADOS</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="vacaciones.php" class="nav-link active">Listado de la empresa</a></li>
								<li class="nav-item"><a href="vacaciones2.php" class="nav-link">Agregar empresa</a></li>
								<li class="nav-item"><a href="vacaciones3.php" class="nav-link">Editar datos de la empresa</a></li>
								<!--<li class="nav-item"><a href="table_styling." class="nav-link">Table styling</a></li>
								<li class="nav-item"><a href="table_elements." class="nav-link">Table elements</a></li>-->
							</ul>
							<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="EMPRESA.php" class="nav-link active">Listado de la empresa</a></li>
								<li class="nav-item"><a href="EMPRESA2.php" class="nav-link">Agregar empresa</a></li>
								<li class="nav-item"><a href="EMPRESA3.php" class="nav-link">Editar datos de la empresa</a></li>
								<!--<li class="nav-item"><a href="table_styling." class="nav-link">Table styling</a></li>
								<li class="nav-item"><a href="table_elements." class="nav-link">Table elements</a></li>-->
							</ul>
						</li>
						<!--<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Inicio</div> <i class="icon-menu" title="Tables"></i></li>-->
						<!--<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs"</div> <i class="icon-menu" title="Tables"></i></li>-->
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-table2"></i> <span>DEPARTAMENTO</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								<li class="nav-item"><a href="tabladedepartamento.php" class="nav-link active">Listado de departamento</a></li>
								<li class="nav-item"><a href="tabladedepartamento2.php" class="nav-link">Agregar departamento</a></li>
								<li class="nav-item"><a href="tabladedepartamento3.php" class="nav-link">Editar datos del departamento</a></li>

								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-alignment-unalign"></i> <span>TRANSPORTE</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								
								<li class="nav-item"><a href="TRANSPORTE.php" class="nav-link">ESCOLAR</a></li>
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								...
								<li class="nav-item nav-item-submenu">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="datatable_extension_buttons_5." class="nav-link">5 buttons</a></li>
									</ul>
								</li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">TRANSPORTE</span>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="table_basic.php" class="breadcrumb-item">Tables</a>
						...
						<div class="breadcrumb justify-content-center">
							...
							<div class="breadcrumb-elements-item dropdown p-0">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="#" class="dropdown-item"><i class="icon-statistics"></i> ANALIZAR</a>
									<a href="#" class="dropdown-item"><i class="icon-accessibility"></i> ACCESIBLIDAD</a>
									<div class="dropdown-divider"></div>
									<a href="#" class="dropdown-item"><i class="icon-gear"></i> BUSCAR</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">Ingrese los datos que se le piden</p>

						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">DATOS DEL ALUMNO</legend>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<div class="input-group">
											<input type="text" class="form-control" placeholder="FECHA DE PAGO">
											<span class="input-group-append">
												<span class="input-group-text"></span>
												<span class="input-group-text"></span>
											</span>
								...
								<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_default">REGISTRAR<i class="icon-play3 ml-2"></i></button> 
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">REGISTRAR INFORMACIÓN </h5>
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>

							<div class="modal-body">
								<h6 class="font-weight-semibold"> ¿Seguro que desa continuar? </h6>
								</p>
							</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-link" data-dismiss="modal">CERRAR</button>
								<button type="button" class="btn bg-primary"> REGISTRAR</button>
							</div>
						</div>
					</div>
				</div>
