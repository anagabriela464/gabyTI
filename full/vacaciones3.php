			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EDICIÓN DE VACACIONES </span></h4>
			...
			<div class="content">
				...
				<div class="card">
					<!--<input type="text" class="form-control" placeholder="Buscar empleado">
							...
							<!--Simple button, supports all sizes and color</td>-->
							<!--</tr>-->
						...
						<table class="table">
							...
							<tr>
								...
								<tr>
									...
									<button type="button" class="btn bg-danger" data-toggle="modal" data-target="#modal_default">EDITAR <i class="icon-play3 ml-2"></i></button> 
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn bg-primary"> EDITAR</button>
							</div>
						</div>
					</div>
				</div>
