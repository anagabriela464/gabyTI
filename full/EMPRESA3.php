					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								...
								<li class="nav-item"><a href="table_sizing.php" class="nav-link">Editar datos del empleado</a></li>
								<li class="nav-item"><a href="table_borders.php" class="nav-link">Agregar empleado</a></li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic tables">
								...
								<li class="nav-item"><a href="tabladedepartamento2.php" class="nav-link">Editar datos del departamento</a><i>
								<li class="nav-item"><a href="tabladedepartamento3.php" class="nav-link">Agregar departamento</a></li>
						<!--<li class="nav-item nav-item-submenu">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">EMPRESAS</span>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>Ortiz</td>
								<td>Ingenierio TI</td>
								<td>Jefe de tecnologias</td>
								<td>831 834 8384</td>
								<td>834 845 9233</td>
								<td>Manuelortiz34@gmail.com</td>
								<td>Creation el gran cambio</td>
								<td>Azucena 345</td>
							...
							<tr>
								...
								<td>831 834 9384</td>
								<td>834 845 1938</td>
								<td>EsmeraldaPineda34@gmail.com</td>
								<td>Beauty</td>
								<td>miguel hidalgo 345</td>
								<td><span class="badge badge-success">Active</span></td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
							...
							<tr>
								...
								<td>Ortiz</td>
								<td>Ingenierio TI</td>
								<td>Área-tecnologías</td>
								<td>831 834 67848</td>
								<td>834 845 9384</td>
								<td>Rocio8273@gmail.com</td>
								<td>Nature</td>
								<td>Azucena 345</td>
								<td><span class="badge badge-success">Active</span></td>
								<td class="text-center">
							...
							<td><button type="button" class="btn bg-teal-300" data-toggle="modal" data-target="#modal_theme_bg_custom">Editar <i class="icon-play3 ml-2"></i></button></td>
